...
@RestController
@RequestMapping("/api/courier-server-kafka")
public class CourierServerKafkaResource {

    private final Logger log = LoggerFactory.getLogger(CourierServerKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public CourierServerKafkaResource(KafkaProperties kafkaProperties) {
