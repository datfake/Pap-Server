...
import com.pap.config.KafkaProperties;
...
@RestController
@RequestMapping("/api/restaurant-server-kafka")
public class RestaurantServerKafkaResource {

    private final Logger log = LoggerFactory.getLogger(RestaurantServerKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public RestaurantServerKafkaResource(KafkaProperties kafkaProperties) {
