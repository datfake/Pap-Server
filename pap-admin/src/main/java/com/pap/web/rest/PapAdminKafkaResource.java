...
@RestController
@RequestMapping("/api/pap-admin-kafka")
public class PapAdminKafkaResource {

    private final Logger log = LoggerFactory.getLogger(PapAdminKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public PapAdminKafkaResource(KafkaProperties kafkaProperties) {
