...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer(javax.cache.configuration.Configuration<Object, Object> jcacheConfiguration) {
        return cm -> {
            createCache(cm, CustomerRepository.USERS_BY_PHONE_CACHE, jcacheConfiguration);
            createCache(cm, CustomerRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
            createCache(cm, Customer.class.getName(), jcacheConfiguration);
            createCache(cm, ManagerRestaurantRepository.USERS_BY_PHONE_CACHE, jcacheConfiguration);
            createCache(cm, ManagerRestaurantRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
            createCache(cm, ManagerRestaurant.class.getName(), jcacheConfiguration);
