...
@RestController
@RequestMapping("/api/customer-server-kafka")
public class CustomerServerKafkaResource {

    private final Logger log = LoggerFactory.getLogger(CustomerServerKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public CustomerServerKafkaResource(KafkaProperties kafkaProperties) {
